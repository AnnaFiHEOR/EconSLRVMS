...
Ankush Taneja, Anna Filonenko, Sachin Kumar, Jenny Britton, Suzy Paisley, Matthew Woods, Daniel Gladwell. Systematic literature review to identify the economic and quality of life evidence for the treatment of moderate-to-severe vasomotor symptoms (VMS) associated with menopause. 
PROSPERO 2022 CRD42022312194 Available from: https://www.crd.york.ac.uk/prospero/display_record.php?ID=CRD42022312194
## Review question
...
* What methods and data have been used to model the published economic evaluations/models for the moderate-to- severe VMS associated with menopause?
* What cost and resource groups, estimates and data sources have been used to assess the costs for the treatment of moderate-to-severe VMS associated with menopause?
* What utility inputs, estimates and valuations have been used to assess the utilities associated with moderate-to-severe VMS in menopause?
...
Conference proceedings will also be hand-searched for the last 2 years (2019–2021) to identify the abstracts of interest. The following list of conferences will be searched for the economic SLRs:
...
Relevant systematic reviews will be included to identify the unique studies not identified from the electronic database searching
...
- Including but not limited to measurement and sources of effectiveness, safety, cost data, resource use data, utility, health states
Model assumptions
- Discounting
...
Study selection
- Records will be screened in line with the expected needs of global HTA submission templates (NICE etc.) by two independent reviews
- Screening will be performed in two stages with title/abstract screening in the first stage followed by full text screening of the articles
...
- The key information to be captured in the extraction grid is presented below (a non-exhaustive list)
  - Study characteristics (country/location, setting, study design, study methods, source of funding, competing interest, etc.)
  - Patient characteristics (inclusion/exclusion criteria, baseline characteristics, etc.) o Type of intervention
  ...
  - Summary health outcomes (e.g. quality-adjusted life years [QALYs] and life years gained) o Direct, indirect and total costs, and incremental cost-effectiveness analysis
...
- Women who have previously tried a hormonal method or contraindicated/intolerance to HT due to obesity or smoking
